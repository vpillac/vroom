...
/**
 * The class <code>ExampleVNS</code> is an example for the {@link VNS} optimization procedure.
 * <p>
 * Creation date: 13/05/2013 - 1:44:01 PM
 * 
 * @author vpillac, <a href="http://www.nicta.com.au">National ICT Australia</a>
 * @version 1.0
 */
public class ExampleVNS extends ExampleBase {

    private final CW  mCW;
    private final VNS mVNS;

    public ExampleVNS(StaticInstance instance, BestKnownSolutions bks) {
        super(instance, bks);
        ...
        mVNS = new VNS(getInstance(), constraintHandler, null);
    }
    ...
    public static void main(String[] args) {
        ...
        ExampleVNS example = new ExampleVNS(VRPUtilities.pickInstance(), VRPUtilities.getBKS());
        example.call();
